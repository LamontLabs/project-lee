...
const EVENT_TYPES = [
  ...
  "IntentClassified","IntentCorrected","ExplanationGenerated","ExplanationInvalidated","ProjectMomentumChanged","OpportunityDetected","OpportunityResolved","OperationalCapacityChanged","AnchorCreated","AnchorRetired","AnchorContradictionDetected",
