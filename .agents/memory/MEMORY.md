...
- [Historical belief state](historical-belief-state.md) — revisions append with prior links and evidence; predictions, causal claims, and gaps remain separate from facts.
