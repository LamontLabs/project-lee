...
export async function indexObject(objectId: string, objectType: string) {
  ...
  assertDerivedMemoryWrite({ projection: "semantic_index", rebuildable: true, sourceRefs: [objectId] });
...
export async function rebuildIndex() {
  assertDerivedMemoryWrite({ projection: "semantic_index", rebuildable: true });
