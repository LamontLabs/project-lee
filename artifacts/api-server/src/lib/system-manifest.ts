...
export async function generateManifest() {
  ...
  const [objects, facts, interpretations, people, assumptions, sources, events, engines, connectors, policies, provisions, indexes, backups, costs, routes, tests, states, internalServices, loops, capacities] = await Promise.all([
