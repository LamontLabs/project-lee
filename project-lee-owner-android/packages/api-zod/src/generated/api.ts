...
export const HealthCheckResponse = zod.object({
  ...
  "contractVersion": zod.string().optional(),
...
export const RunScheduledJobResponse = zod.object({
  ...
  "eventId": zod.string().uuid().nullable(),
  "message": zod.string()
})
...
export const EvaluateGovernedRequestBody = zod.object({
  ...
  "request_checksum": zod.string().optional(),
...
export const EvaluateGovernedRequestResponse = zod.object({
  ...
  "missing_approvals": zod.array(zod.record(zod.string(), zod.unknown())).optional(),
  "remediation_requirements": zod.array(zod.string()).optional(),
...
/**
 * @summary List deterministic experiences eligible for historical replay
 */
