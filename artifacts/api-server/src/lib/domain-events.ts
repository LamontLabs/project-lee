...
const EVENT_TYPES = [
  ...
  "BriefGenerated","BriefRegenerated","ConnectorSynced","ConnectorFailed","ConnectorResumed","ProviderReconnected","ProviderRefreshUnavailable",
  ...
  "BrainVersionChanged","BackupCompleted","BackupFailed","ModeChanged","StateChanged","EngineRegistered","EngineUnavailable","EnginePaused","EngineResumed","EngineShutdown","SelfTestCompleted","RecoveryAttempted","RecoverySucceeded","RecoveryFailed","BootStarted","BootCompleted","CleanShutdownRecorded","SafeModeActivated","RecoveryCompleted","OwnerVerified","KnowledgeAged","KnowledgeStale","ManifestGenerated","WorldStateUpdated","OperationalPatternEstablished","OperationalPatternBroken","InitiativeItemCreated","OperationalContextUpdated",
    ...
    "ConsolidationRunStarted","ConsolidationPhaseCompleted","ConsolidationPhaseFailed","ConsolidationDeferred","ConsolidationCompleted","MemoryCooled","SourceArchived","ResourceStateSampled","LocalCognitionRunCompleted","LocalCognitionRunFailed","LocalCognitionBlocked","LocalRuntimeHealthChanged",
  "ArchiveManifestCreated","ArchiveIntegrityVerified","ArchiveIntegrityFailed","RetentionDecisionRequested","RetentionDecisionApproved","RetentionDecisionRejected","RetentionApplied","StoragePressureAssessed","ArchiveMovedCold","K6AuthorityRehearsalRecorded",
  "PersonalityMemoryInitialized","PersonalityMemoryProposed","PersonalityMemoryAccepted","PersonalityMemoryRejected","PersonalityMemoryReversed",
] as const;
