...
export default function ApprovalsTab() {
  ...
  const { api, approvals: cachedApprovals, hosted, decideApproval, askWhy: askWhyRemote, refresh } = useLee();
  const approvals = cachedApprovals?.value ?? [];
  ...
  return (
    <Screen refreshing={false} onRefresh={() => void refresh()}>
      ...
      }) : <Card><Text style={[styles.body, { color: colors.mutedForeground }]}>No governed action is waiting for your decision.</Text></Card>}
      <LeeSheet
        colors={colors}
