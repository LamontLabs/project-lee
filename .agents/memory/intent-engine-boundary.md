...
**How to apply:** Classify once per request, pass the record downstream, use semantic retrieval for exploratory intent, and route corrections to Learning rather than silently overwriting history.