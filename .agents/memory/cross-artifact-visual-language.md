---
name: Cross-artifact visual language
...
**How to apply:** Keep semantic tokens aligned across artifacts. Use the canonical icon asset rather than recreating a placeholder brand mark. Use sheen and grain sparingly for hierarchy, reserve the brightest red for action/focus, keep body text near-white, and preserve accessible focus states and reduced-motion behavior. Desktop inherits the Console language; Android mirrors the same roles in native color tokens.