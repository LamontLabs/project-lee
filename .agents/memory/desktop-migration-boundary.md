...
**How to apply:** Keep migration assets in the release resource staging path for every desktop platform, and preserve the development command only as a non-packaged override.