...
export const getRecordDeliveryEvidenceUrl = () => {




  return `/api/bootstrap-awareness/delivery-evidence`
}
 ...
 */
export const recordDeliveryEvidence = async (recordDeliveryEvidenceBody: RecordDeliveryEvidenceBody, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getRecordDeliveryEvidenceUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(recordDeliveryEvidenceBody)
  }
);}
...
export const getRecordDeliveryEvidenceMutationOptions = <TError = ErrorType<void>,
...
): UseMutationOptions<Awaited<ReturnType<typeof recordDeliveryEvidence>>, TError,{data: BodyType<RecordDeliveryEvidenceBody>}, TContext> => {

const mutationKey = ['recordDeliveryEvidence'];
...
/**
 * Returns process liveness plus hosted database, storage, identity, and canonical boot readiness.
 * @summary Canonical Core readiness check
 */
