ptions.mutation, mutationKey}}
      : {mutation: { mutationKey, }, request: undefined};




      const mutationFn: MutationFunction<Awaited<ReturnType<typeof recordDeliveryEvidence>>, {data: BodyType<RecordDeliveryEvidenceBody>}> = (props) => {
          const {data} = props ?? {};

          return  recordDeliveryEvidence(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RecordDeliveryEvidenceMutationResult = NonNullable<Awaited<ReturnType<typeof recordDeliveryEvidence>>>
    export type RecordDeliveryEvidenceMutationBody = BodyType<RecordDeliveryEvidenceBody>
    export type RecordDeliveryEvidenceMutationError = ErrorType<void>

    /**
 * @summary Record signed delivery evidence
 */
export const useRecordDeliveryEvidence = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recordDeliveryEvidence>>, TError,{data: BodyType<RecordDeliveryEvidenceBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof recordDeliveryEvidence>>,
        TError,
        {data: BodyType<RecordDeliveryEvidenceBody>},
        TContext
      > => {
      return useMutation(getRecordDeliveryEvidenceMutationOptions(options));
    }
