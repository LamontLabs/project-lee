...
const foundation = await fs.readFile(new URL("../packages/mobile-foundation/src/index.ts", import.meta.url), "utf8");
...
test("Owner cache and queue use protected bounded persistence with identity metadata", () => {
...
test("Owner capture uploads carry stable identity and acknowledgements", () => {
