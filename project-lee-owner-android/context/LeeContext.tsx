...
export function LeeProvider({ children }: { children: React.ReactNode }) {
  ...
  }), [pairing, captures, uncertainty, brief, waiting, alerts, approvals, connections, runtime, contract, health, readiness, confidence, projectOperations, selfAwareness, hosted, observationSession, isLoading, syncCapture, refreshHosted, enqueuePerception]);
