...
import memoryConsolidationRouter from "./memory-consolidation";
...
import bootstrapAwarenessRouter from "./bootstrap-awareness";
...
router.use(memoryConsolidationRouter);
...
router.use(bootstrapAwarenessRouter);
