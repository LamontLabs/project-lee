...
When resetting a never-used development workspace, remove seeded canonical content together with its derived analysis projections and invalidate the query cache. Keep operational configuration and live system-health records unless the owner explicitly asks for a full system reset.
