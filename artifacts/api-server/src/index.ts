...
import { ensureCognitiveRuntimeJob } from "./lib/cognitive-runtime";
...
ensureCognitiveRuntimeJob().catch((err) => logger.error({ err }, "Cognitive runtime job registration failed"));
